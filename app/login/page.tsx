...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Redirect based on role — refetch session
  ...
  return (
    <div className="auth-page">
      ...
      >
        ...
        <p className="auth-subheading">Sign in to your academy account</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          {errors.general && <p className="auth-error-banner">{errors.general}</p>}
        ...
        <p className="auth-switch">
          ...
          <Link href="/register" className="auth-switch-link">Create one →</Link>
        </p>
